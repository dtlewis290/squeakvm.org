/* Smalltalk from Squeak4.5 with VMMaker 4.15.9 translated as C source on 8 November 2016 5:28:23 pm */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.387 uuid: ef7038c9-f871-4632-b087-ba2f03a89ebc
   from
	ContextInterpreter VMMaker-dtl.387 uuid: ef7038c9-f871-4632-b087-ba2f03a89ebc
 */
static char __buildInfo[] = "ContextInterpreter VMMaker-dtl.387 uuid: ef7038c9-f871-4632-b087-ba2f03a89ebc " __DATE__ ;
...
#define InterpreterSourceVersion "4.15.9"
...
l1:	/* end stackObjectValue: */;
	/* begin stackObjectValue: */
	oop2 = longAt(foo->stackPointer - (1 * (BYTES_PER_WORD)));
	if ((oop2 & 1)) {
		/* begin primitiveFail */
		if (foo->primFailCode == 0) {
			foo->primFailCode = 1;
...
l2:	/* end stackObjectValue: */;
	...
	argClass = (((ccIndex = (((usqInt) (longAt(arg))) >> 12) & 0x1F)) == 0
		? (longAt(arg - (BASE_HEADER_SIZE))) & (ALL_BUT_TYPE_MASK)
		: /* begin fetchPointer:ofObject: */(oop = longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (CompactClasses << (SHIFT_FOR_WORD)))),longAt((oop + (BASE_HEADER_SIZE)) + ((ccIndex - 1) << (SHIFT_FOR_WORD))));
