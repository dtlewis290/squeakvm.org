/* Smalltalk from Squeak4.6 with VMMaker 4.16.7 translated as C source on 26 September 2019 7:37:58 pm */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.402 uuid: ac8bd24c-b252-4e8f-a6c6-f8884f0cdf6f
   from
	ContextInterpreter VMMaker-dtl.402 uuid: ac8bd24c-b252-4e8f-a6c6-f8884f0cdf6f
 */
static char __buildInfo[] = "ContextInterpreter VMMaker-dtl.402 uuid: ac8bd24c-b252-4e8f-a6c6-f8884f0cdf6f " __DATE__ ;
...
#define InterpreterSourceVersion "4.16.7"
...
register struct foo * foo = &fum;
    ...
    sqInt memStart;
    sqInt minimumMemory;
    usqInt savedOldMemoryAddress;
    sqImageFile  unusedFileReference;
	...
	savedOldMemoryAddress = sqMemoryBase;
	flag("FIXME");
...
register struct foo * foo = &fum;
	...
	longAtput((results + (BASE_HEADER_SIZE)) + (7 << (SHIFT_FOR_WORD)), ((0 << 1) | 1));
	/* begin storePointer:ofObject:withValue: */
	if ((((usqInt) results)) < (((usqInt) foo->youngStart))) {
...
register struct foo * foo = &fum;
	...
	/* begin swapBytesAndPrepareToInterpret:oldBaseAddr: */
