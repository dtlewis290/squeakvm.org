/* Smalltalk from Squeak4.5 with VMMaker 4.16.1 translated as C source on 2 January 2017 8:53:04 pm */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.390 uuid: 1fb628a6-18d2-4d86-b651-dc3b3d0cce69
   from
	ContextInterpreter VMMaker-dtl.390 uuid: 1fb628a6-18d2-4d86-b651-dc3b3d0cce69
 */
static char __buildInfo[] = "ContextInterpreter VMMaker-dtl.390 uuid: 1fb628a6-18d2-4d86-b651-dc3b3d0cce69 " __DATE__ ;
...
#define InterpreterSourceVersion "4.16.1"
...
sqInt updatePrimitiveTable(void) {
	...
	if (!(primitiveTableUpdated == 1)) {
		...
		if (!((imageFormatVersionNumber != 6502) && (imageFormatVersionNumber != 68000))) {
			...
			installPrimitivefromat("primWaveTableSoundmixSampleCountintostartingAtpan", "SoundPlugin", 176);
			installPrimitivefromat("primFMSoundmixSampleCountintostartingAtpan", "SoundPlugin", 177);
			installPrimitivefromat("primPluckedSoundmixSampleCountintostartingAtpan", "SoundPlugin", 178);
			installPrimitivefromat("primSampledSoundmixSampleCountintostartingAtpan", "SoundPlugin", 179);
			installPrimitivefromat("primitiveMixFMSound", "SoundPlugin", 180);
			installPrimitivefromat("primitiveMixPluckedSound", "SoundPlugin", 181);
			installPrimitivefromat("oldprimSampledSoundmixSampleCountintostartingAtleftVolrightVol", "SoundPlugin", 182);
			installPrimitivefromat("primitiveApplyReverb", "SoundPlugin", 183);
			installPrimitivefromat("primitiveMixLoopedSampledSound", "SoundPlugin", 184);
			installPrimitivefromat("primitiveMixSampledSound", "SoundPlugin", 185);
