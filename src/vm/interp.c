/* Smalltalk from Squeak4.6 with VMMaker 4.19.6 translated as C source on 20 March 2021 12:29:19 pm */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.423 uuid: b744c4a9-0a90-4104-8680-6e815df0f064
   from
	ContextInterpreter VMMaker-dtl.423 uuid: b744c4a9-0a90-4104-8680-6e815df0f064
 */
static char __buildInfo[] = "ContextInterpreter VMMaker-dtl.423 uuid: b744c4a9-0a90-4104-8680-6e815df0f064 " __DATE__ ;
...
#define InterpreterSourceVersion "4.19.6"
...
const char *interpreterVersion = "Squeak4.6 of 11 December 2017 [latest update: #15117]";
...
register struct foo * foo = &fum;
	...
	if (((memory = (usqInt)allocateMemoryMinimumImageFileHeaderSize(heapSize, minimumMemory, unusedFileReference, unusedHeaderSize))) == null) {
		insufficientMemoryAvailableError();
	}
	/* begin setMemoryLimit: */
	foo->memoryLimit = (usqInt)(memory + heapSize) - 24;
	/* begin setEndOfMemory: */
	foo->endOfMemory = (usqInt)memory + dataSize;
	return null;
}
