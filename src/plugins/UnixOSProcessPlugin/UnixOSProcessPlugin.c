/* Smalltalk from Squeak4.6 with VMMaker 4.19.2 translated as C source on 18 October 2020 4:51:42 pm */
/* Automatically generated by
	VMPluginCodeGenerator VMMaker-dtl.418 uuid: 39e895ba-407a-4226-ab73-3634b979ea77
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin-dtl.53 uuid: 4e220e08-4742-4139-8b9f-bbf8008c0865
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin-dtl.53 uuid: 4e220e08-4742-4139-8b9f-bbf8008c0865 " __DATE__ ;
...
/* D T Lewis - UnixOSProcessPlugin.c translated from class
   UnixOSProcessPlugin of OSProcessPlugin version 4.6.7 */
#include <sys/time.h>
#include <sys/wait.h>
#include <signal.h>
#include <unistd.h>
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"UnixOSProcessPlugin 18 October 2020 (i)"
#else
	"UnixOSProcessPlugin 18 October 2020 (e)"
#endif
;
