/* Smalltalk from Squeak4.5 with VMMaker 4.16.5 translated as C source on 20 January 2019 4:51:54 pm */
/* Automatically generated by
	VMPluginCodeGenerator * VMMaker-dtl.396 uuid: 4692f226-29a6-4aaf-b6ce-5cb5d5e5fb74
   from
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"UnixOSProcessPlugin 20 January 2019 (i)"
#else
	"UnixOSProcessPlugin 20 January 2019 (e)"
#endif
;
...
static sqInt initializeModuleForPlatform(void) {
	...
	vmThread = (pthread_t)pthread_self();
...
EXPORT(sqInt) primitiveKillOnExit(void) {
	...
	pidArray = (pid_t  *)malloc(pidCount * sizeof(pid_t));
	if (pidArray == 0) {
		pidCount = 0;
		return interpreterProxy->primitiveFail();
	}
