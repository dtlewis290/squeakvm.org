/* Smalltalk from Squeak4.6 with VMMaker 4.20.2 translated as C source on 1 August 2022 8:27:07 pm */
/* Automatically generated by
	VMPluginCodeGenerator VMMaker-dtl.436 uuid: fce55fb3-ce12-4897-a865-75341a26701e
   from
	FilePlugin VMMaker-dtl.436 uuid: fce55fb3-ce12-4897-a865-75341a26701e
 */
static char __buildInfo[] = "FilePlugin VMMaker-dtl.436 uuid: fce55fb3-ce12-4897-a865-75341a26701e " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin 1 August 2022 (i)"
#else
	"FilePlugin 1 August 2022 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
EXPORT(sqInt) primitiveDirectoryLookup(void) {
	...
	interpreterProxy->popthenPush(3, 
# if (PharoVM)
