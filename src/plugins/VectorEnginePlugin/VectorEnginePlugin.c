/* Smalltalk from Squeak4.6 with VMMaker 4.19.12 translated as C source on 24 August 2021 12:37:14 pm */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"VectorEnginePlugin 24 August 2021 (i)"
#else
	"VectorEnginePlugin 24 August 2021 (e)"
#endif
;
