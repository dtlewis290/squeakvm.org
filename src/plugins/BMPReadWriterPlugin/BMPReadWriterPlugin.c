/* Smalltalk from Squeak4.6 with VMMaker 4.20.8 translated as C source on 18 March 2024 1:43:19 pm */
/* Automatically generated by
	VMPluginCodeGenerator VMMaker-dtl.442 uuid: fa3530b4-3415-49e2-8448-53850dcd6005
   from
	BMPReadWriterPlugin VMMaker-dtl.442 uuid: fa3530b4-3415-49e2-8448-53850dcd6005
 */
static char __buildInfo[] = "BMPReadWriterPlugin VMMaker-dtl.442 uuid: fa3530b4-3415-49e2-8448-53850dcd6005 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"BMPReadWriterPlugin 18 March 2024 (i)"
#else
	"BMPReadWriterPlugin 18 March 2024 (e)"
#endif
;
...
EXPORT(sqInt) primitiveRead24BmpLine(void) {
	...
	if (!((((formBitsIndex + width) - 1) <= formBitsSize) && ((width * 3) <= pixelLineSize))) {
		return interpreterProxy->primitiveFail();
	}
